...
export default function SelectionOrganizer(canvas, elementRegistry, eventBus, modeling, selection, keyboard) {
  ...
  SelectionOrganizer.HTML_MARKUP = `<li>
      <button id="js-toggle-grid-align" class="pjs-buttons-active" title="Grid-align elements in selection">
  ...
  button.pjs-buttons-active.icon-grid-align {
    opacity: 1.0;
    box-shadow: 0px 2px 2px 0 rgba(0, 0, 0, 0.1);
  }

  li button#js-toggle-grid-align {
    visibility:hidden;
  }
  `;
  ...
  function executeGridAlign() {
    ...
    gridAlignButton.style.visibility = 'hidden';
  }


  function activateGridAlignButton(elements) {
    self.lastSelection = elements;
    gridAlignButton.style.visibility = 'visible';
  }
